...
local phrase = "WHAT THE FUCK IS A KILOMETER"
...
clock = wibox.widget{
  {
    ...
    {
      {
        format = '<span foreground="'..colors.frost.lightest..'"><i>%A</i></span>',
        font = "Roboto 20",
        align = 'top',
        widget = wibox.widget.textclock
      },
  ...
  local menu = wibox.widget{
    {
      ...
      shape_border_color = colors.light.lighter .. "0e",
