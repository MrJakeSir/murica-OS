...
if awesome.startup_errors then
    awesome.spawn.with_shell('dunstify "oops, an error happened: " '..tostring(awesome.startup_errors))
end
...
do
    ...
    awesome.connect_signal("debug::error", function (err)
        ...
        awesome.spawn.with_shell('dunstify "oops, an error happened: " '..tostring(err))
        in_error = false
    end)
end
-- }}}
...
globalkeys = my_table.join(
    ...
    -- vivaldi
    awful.key({ modkey }, "w", function () awful.util.spawn( "vivaldi-stable" ) end,
    ...
    -- Abre Office
    awful.key({ modkey }, "g", function () awful.util.spawn( "onlyoffice-desktopeditors" ) end,
 ...
 -- Show/Hide Systray
    ...
    awful.key({modkey}, "k", function () awful.util.spawn("/home/jake/.config/awesome/kb.sh") end,
              {description = "Change keyboard map", group = "super"}),
    

    awful.key({}, "Print", function () awful.util.spawn_with_shell("flameshot gui") end,
              {description = "Run screenshooter", group = "super"}),
    -- Standard program
